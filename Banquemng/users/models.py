...
class User(models.Model):
    ...
    email_id = models.CharField(max_length=30,uniqe=True)
    mobile_no= models.IntegerField(max_length=10,uniqe=True)
    address = models.TextField()
    city_id = models.ForeignKey(city,on_delete=models.CASCADE)
    pincode = models.IntegerField(max_length=6)
    id_proof_doc_path = models.CharField(max_length=100,null=True)
